...
namespace lab6._1
{
    public partial class RegForm : Form
    {
        ...
        private void RegForm_Load(object sender, EventArgs e)
        {
            ...
            // TODO: данная строка кода позволяет загрузить данные в таблицу "regautDataSet.user". При необходимости она может быть перемещена или удалена.
            this.userTableAdapter.Fill(this.regautDataSet.user);
